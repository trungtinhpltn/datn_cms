...
import { useCreateEmployee } from 'mutation/employee.mutation'
import { Controller } from 'react-hook-form'
import { provinceAPI } from 'services/province.service'
import * as yup from 'yup'

const MangermentStaffCreate = () => {
    ...
    <EditView<CreateEmployeeDto>
      ...
      onSubmit={async ({ data }) => {
        const cleanData: any = {
          ...
          restaurantId: restaurantSelect?.id || undefined,
        ...
        await createEmployeeMutate.mutateAsync(cleanData)
      }}
      changeMode={false}
      renderView={({
        form: {
...
export default MangermentStaffCreate
